...
from model.peliculas_dao import crear_tabla, borrar_tabla, Pelicula, guardar, listar, editar, eliminar_pelicula
...
class Frame(tk.Frame):
    ...
    def campos_peliculas(self):
        ...
        self.boton_nuevo.config(width=20, font= ("Arial", 12, "bold"), bg= "#158645", fg = "#DAD5D6", cursor="hand2", activebackground="#35BD6F"  )
        self.boton_nuevo.grid(row=3, column=0, padx=10, pady=10)
        
        self.boton_guardar = tk.Button(self, text = "Guardar", command=self.guardar_datos)
        self.boton_guardar.config(width=20, font= ("Arial", 12, "bold"), bg= "#1658A2", fg = "#DAD5D6", cursor="hand2", activebackground="#3586DF"  )
        self.boton_guardar.grid(row=3, column=1, padx=10, pady=10)

        self.boton_cancelar = tk.Button(self, text = "Cancelar", command=self.desabiliar_campos)
        self.boton_cancelar.config(width=20, font= ("Arial", 12, "bold"), bg= "#BD152E", fg = "#DAD5D6", cursor="hand2", activebackground="#E15370"  )
    ...
    def tabla_peliculas(self):
        ...
        #scrillbar para la tabla si exede 10 registros
        ...
        self.boton_eliminar = tk.Button(self, text="Eiminar", command=self.eliminar_pelicula)
    ...
    def eliminar_pelicula(self):
        try:
            self.id_pelicula = self.tabla.item(self.tabla.selection())["text"]
            eliminar_pelicula(self.id_pelicula)
            self.tabla_peliculas()    
            self.id_pelicula = None             
